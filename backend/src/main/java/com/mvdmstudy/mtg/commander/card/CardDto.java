...
public record CardDto(UUID id, String name, String manaCost, String types, String imageURL, String power,
    ...
    public static CardDto from(Card card) {
        ...
        return new CardDto(card.getId(), card.getName(), card.getManaCost(), card.getTypes(), card.getImageURL(),
